...
export function FooterSection2() {
  return (
    <main className="flex overflow-hidden relative flex-col justify-center text-white">
     ...
     <div>
     <h1 className=" font- z-0 text-xs sm:text-5xl font-bold leading-none max-md:max-w-full max-md:text-xl">
          Join ShamPooDao
        </h1>
     </div>
       <div>
       <Link
        href="/product"
          className=" w-42 sm:mt-8 sm:w-42 flex items-center text-center justify-center self-stretch px-8 py-3 sm:py-4 mt-2 sm:mb-0 mb-4 text-sm sm:text-base bg-black font-[350] rounded-[80px] max-md:px-5 font-gothamBook"
          type="button"
