  ...
  return (
    <main className="flex overflow-hidden relative flex-col justify-center text-white">
      <div className="flex relative  z-0 flex-col items-center self-center max-md:max-w-full">
        <Image
          loading="lazy"
          src={'/FoolPoolfooter.jpg'}
         
          width={2479}
          height={855}
       
          
           className="  z-0 self-start aspect-[2.07] h-[700px] left-[-931px] top-[-574px] w-[2479px] "
     ...
     <div>
     <h1 className=" font-hornbill z-0 text-xs sm:text-5xl  leading-none max-md:max-w-full max-md:text-xl">
          Want better hair?
        </h1>
     </div>
       <div>
       <Link
        href="/product"
          className=" w-42 sm:mt-8 sm:w-42 flex items-center text-center justify-center self-stretch px-8 py-3 sm:py-4 mt-2 sm:mb-0 mb-4 text-sm sm:text-sm bg-black font-[350] rounded-[80px] max-md:px-5 font-gothamBook"
          type="button"
